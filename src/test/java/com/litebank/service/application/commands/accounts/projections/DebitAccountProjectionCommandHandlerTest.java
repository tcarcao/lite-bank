...
public class DebitAccountProjectionCommandHandlerTest {
    @Test
    public void execute_everythingOk() {
        ...
        var command = new DebitAccountProjectionCommand(accountId, amount, timestamp);
        var handler = new DebitAccountProjectionCommandHandler(accountProjectionRepository);
        ...
        assertEquals(TransactionType.DEBIT, transactionProjection.getType());
    }
}